...
var Csosn101 = /** @class */ (function (_super) {
    __extends(Csosn101, _super);
    function Csosn101(origemMercadoria, tipoDesconto) {
        ...
        _this.csosn = Csosn_1.Csosn.csosn101;
        return _this;
    }
    Csosn101.prototype.calcula = function (tributavel) {
        var resultadoCalculoIcmsCredito = new FacadeCalculadoraTributacao_1.FacadeCalculadoraTributacao(tributavel, this.tipoDesconto).calculaIcmsCredito();
