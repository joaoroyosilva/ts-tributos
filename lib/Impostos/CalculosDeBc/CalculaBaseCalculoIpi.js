...
exports.CalculaBaseCalculoIpi = void 0;
var TipoDesconto_1 = require("../../Flags/TipoDesconto");
var CalculaBaseCalculoBase_1 = require("./Base/CalculaBaseCalculoBase");
var CalculaBaseCalculoIpi = /** @class */ (function (_super) {
    __extends(CalculaBaseCalculoIpi, _super);
    function CalculaBaseCalculoIpi(tributavel, tipoDesconto) {
        var _this = _super.call(this, tributavel) || this;
        _this.tributavel = tributavel;
        _this.tipoDesconto = tipoDesconto;
        return _this;
    }
    CalculaBaseCalculoIpi.prototype.calculaBaseDeCalculo = function () {
    ...
    CalculaBaseCalculoIpi.prototype.calculaIcmsComDescontoIncondicional = function (baseCalculoInicial) {
        var baseCalculo = baseCalculoInicial - this.tributavel.desconto;
        return baseCalculo;
    };
    CalculaBaseCalculoIpi.prototype.calculaIcmsComDescontoCondicional = function (baseCalculoInicial) {
        var baseCalculo = baseCalculoInicial + this.tributavel.desconto;
        return baseCalculo;
    };
    return CalculaBaseCalculoIpi;
}(CalculaBaseCalculoBase_1.CalculaBaseCalculoBase));
exports.CalculaBaseCalculoIpi = CalculaBaseCalculoIpi;
