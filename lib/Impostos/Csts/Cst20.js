...
var Cst20 = /** @class */ (function (_super) {
    __extends(Cst20, _super);
    function Cst20(origemMercadoria, tipoDesconto) {
        ...
        _this.cst = Cst_1.Cst.cst20;
        return _this;
    }
    Cst20.prototype.calcula = function (tributavel) {
        _super.prototype.calcula.call(this, tributavel);
        this.percentualReducao = tributavel.percentualReducao;
        this.valorBcFcp = new FacadeCalculadoraTributacao_1.FacadeCalculadoraTributacao(tributavel, this.tipoDesconto).calculaFcp().baseCalculo;
    };
    return Cst20;
}(Cst00_1.Cst00));
exports.Cst20 = Cst20;
