...
var Cst30 = /** @class */ (function (_super) {
    __extends(Cst30, _super);
    function Cst30(origemMercadoria, tipoDesconto) {
        ...
        _this.cst = Cst_1.Cst.cst30;
        return _this;
    }
    Cst30.prototype.calcula = function (tributavel) {
        ...
        var resultadoCalculoFcfpSt = facadeCalculadoraTributacao.calculaFcpSt();
